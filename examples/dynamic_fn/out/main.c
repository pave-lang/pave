...
int32_t main(int32_t argc, char const** argv) {
    struct Array_Object objects = Array_Object__new((struct trait_Allocator) { .vtable = &GENERAL_PURPOSE_ALLOCATOR__VTABLE__ALLOCATOR, .instance = GeneralPurposeAllocator__default() });
