...
void HashMap_usize_TypeUsage_Sequence__resize(struct HashMap_usize_TypeUsage_Sequence* self, uintptr_t new_capacity) {
    ...
    self->buckets = self->allocator.vtable->fn_realloc(self->allocator.instance, self->buckets, new_capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Sequence*));
    #line 56 "src/std/HashMap.pv"
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, new_capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Sequence));
...
struct TypeUsage_Sequence* HashMap_usize_TypeUsage_Sequence__insert(struct HashMap_usize_TypeUsage_Sequence* self, uintptr_t key, struct TypeUsage_Sequence value) {
    ...
    struct HashMapBucket_usize_TypeUsage_Sequence* bucket_node = *current_bucket_node;
...
struct HashMap_usize_TypeUsage_Sequence HashMap_usize_TypeUsage_Sequence__clone(struct HashMap_usize_TypeUsage_Sequence* self, struct trait_Allocator allocator) {
    ...
    struct HashMap_usize_TypeUsage_Sequence other = (struct HashMap_usize_TypeUsage_Sequence) {
        ...
        .data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Sequence)),
        .length = self->length,
...
struct HashMapBucket_usize_TypeUsage_Sequence* HashMap_usize_TypeUsage_Sequence__Index__index(void* __self) {
    struct HashMap_usize_TypeUsage_Sequence* self = __self; (void)self;
...
struct trait_Map_usize_TypeUsage_SequenceVTable HASH_MAP_USIZE_TYPE_USAGE_SEQUENCE__VTABLE__MAP = { .fn_find = &HashMap_usize_TypeUsage_Sequence__Map_usize_TypeUsage_Sequence__find, .fn_insert = &HashMap_usize_TypeUsage_Sequence__Map_usize_TypeUsage_Sequence__insert, .fn_remove = &HashMap_usize_TypeUsage_Sequence__Map_usize_TypeUsage_Sequence__remove };
