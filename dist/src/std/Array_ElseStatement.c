...
struct Array_ElseStatement Array_ElseStatement__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_ElseStatement) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_ElseStatement Array_ElseStatement__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_ElseStatement self = (struct Array_ElseStatement) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_ElseStatement__reserve(struct Array_ElseStatement* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct ElseStatement));
...
struct Array_ElseStatement Array_ElseStatement__clone(struct Array_ElseStatement* self, struct trait_Allocator allocator) {
    ...
    struct ElseStatement* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct ElseStatement));
