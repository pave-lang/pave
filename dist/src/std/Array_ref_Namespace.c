...
struct Array_ref_Namespace Array_ref_Namespace__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_ref_Namespace) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_ref_Namespace Array_ref_Namespace__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_ref_Namespace self = (struct Array_ref_Namespace) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_ref_Namespace__reserve(struct Array_ref_Namespace* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct Namespace*));
...
struct Array_ref_Namespace Array_ref_Namespace__clone(struct Array_ref_Namespace* self, struct trait_Allocator allocator) {
    ...
    struct Namespace** data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct Namespace*));
...
struct Iter_ref_ref_Namespace Array_ref_Namespace__iter(struct Array_ref_Namespace* self) {
    ...
    return Iter_ref_ref_Namespace__new(self->data, self->data + self->length);
}
...
struct Namespace** Array_ref_Namespace__Index__index(void* __self) {
    struct Array_ref_Namespace* self = __self; (void)self;
