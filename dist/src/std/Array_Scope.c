...
struct Array_Scope Array_Scope__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_Scope) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_Scope Array_Scope__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_Scope self = (struct Array_Scope) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
struct Scope* Array_Scope__Index__index(void* __self) {
    struct Array_Scope* self = __self; (void)self;
