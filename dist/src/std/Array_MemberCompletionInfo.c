...
struct Array_MemberCompletionInfo Array_MemberCompletionInfo__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_MemberCompletionInfo) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_MemberCompletionInfo Array_MemberCompletionInfo__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_MemberCompletionInfo self = (struct Array_MemberCompletionInfo) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
    #line 83 "src/std/Array.pv"
    Array_MemberCompletionInfo__reserve(&self, length);
...
void Array_MemberCompletionInfo__reserve(struct Array_MemberCompletionInfo* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct MemberCompletionInfo));
...
uintptr_t Array_MemberCompletionInfo__append(struct Array_MemberCompletionInfo* self, struct MemberCompletionInfo value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_MemberCompletionInfo__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_MemberCompletionInfo__prepend(struct Array_MemberCompletionInfo* self, struct MemberCompletionInfo value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct MemberCompletionInfo));
...
bool Array_MemberCompletionInfo__remove_back(struct Array_MemberCompletionInfo* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct MemberCompletionInfo));
...
void Array_MemberCompletionInfo__clear(struct Array_MemberCompletionInfo* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct MemberCompletionInfo));
...
struct Array_MemberCompletionInfo Array_MemberCompletionInfo__clone(struct Array_MemberCompletionInfo* self, struct trait_Allocator allocator) {
    ...
    struct MemberCompletionInfo* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct MemberCompletionInfo));
    #line 174 "src/std/Array.pv"
    memcpy(data, self->data, self->length * sizeof(struct MemberCompletionInfo));

    #line 176 "src/std/Array.pv"
    return (struct Array_MemberCompletionInfo) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct slice_MemberCompletionInfo Array_MemberCompletionInfo__as_slice(struct Array_MemberCompletionInfo* self) {
    ...
    return (struct slice_MemberCompletionInfo) { .data = self->data, .length = self->length };
}

#line 195 "src/std/Array.pv"
struct MemberCompletionInfo* Array_MemberCompletionInfo__Index__index(void* __self) {
    struct Array_MemberCompletionInfo* self = __self; (void)self;
