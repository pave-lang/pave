...
struct HashMap_str_EnumVariant HashMap_str_EnumVariant__new(struct trait_Allocator allocator) {
    ...
    return HashMap_str_EnumVariant__with_capacity(allocator, 16);
}
...
struct HashMap_str_EnumVariant HashMap_str_EnumVariant__with_capacity(struct trait_Allocator allocator, uintptr_t capacity) {
    ...
    struct HashMap_str_EnumVariant self = (struct HashMap_str_EnumVariant) {
        .allocator = allocator,
        .buckets = 0,
        .data = 0,
        .capacity = 0,
    ...
    HashMap_str_EnumVariant__resize(&self, capacity);
...
void HashMap_str_EnumVariant__resize(struct HashMap_str_EnumVariant* self, uintptr_t new_capacity) {
    ...
    self->buckets = self->allocator.vtable->fn_realloc(self->allocator.instance, self->buckets, new_capacity * sizeof(struct HashMapBucket_str_EnumVariant*));
    #line 56 "src/std/HashMap.pv"
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, new_capacity * sizeof(struct HashMapBucket_str_EnumVariant));
...
struct EnumVariant* HashMap_str_EnumVariant__insert(struct HashMap_str_EnumVariant* self, struct str key, struct EnumVariant value) {
    ...
    struct HashMapBucket_str_EnumVariant* bucket_node = *current_bucket_node;
    ...
    self->data[self->length] = (struct HashMapBucket_str_EnumVariant) { .key = key, .value = value, .next = 0 };
...
struct HashMap_str_EnumVariant HashMap_str_EnumVariant__clone(struct HashMap_str_EnumVariant* self, struct trait_Allocator allocator) {
    ...
    struct HashMap_str_EnumVariant other = (struct HashMap_str_EnumVariant) {
        ...
        .data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_str_EnumVariant)),
        .length = self->length,
...
struct trait_Map_str_EnumVariantVTable HASH_MAP_STR_ENUM_VARIANT__VTABLE__MAP = { .fn_find = &HashMap_str_EnumVariant__Map_str_EnumVariant__find, .fn_insert = &HashMap_str_EnumVariant__Map_str_EnumVariant__insert, .fn_remove = &HashMap_str_EnumVariant__Map_str_EnumVariant__remove };
