...
struct Array_ForVariable Array_ForVariable__new(struct Allocator allocator) {
    #line 78 "src/std/Array.pv"
    return (struct Array_ForVariable) { .allocator = allocator };
}

#line 81 "src/std/Array.pv"
struct Array_ForVariable Array_ForVariable__new_with_length(struct Allocator allocator, uintptr_t length) {
...
struct Array_ForVariable Array_ForVariable__new_with_capacity(struct Allocator allocator, uintptr_t length) {
...
struct Array_ForVariable Array_ForVariable__clone(struct Array_ForVariable* self, struct Allocator allocator) {
...
struct ArrayIter_ref_ForVariable Array_ForVariable__iter(struct Array_ForVariable* self) {
    ...
    return ArrayIter_ref_ForVariable__new((void*)(self->data), (void*)(self->data + self->length));
}
