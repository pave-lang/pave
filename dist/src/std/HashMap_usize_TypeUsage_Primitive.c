...
struct HashMap_usize_TypeUsage_Primitive HashMap_usize_TypeUsage_Primitive__new(struct trait_Allocator allocator) {
    ...
    return HashMap_usize_TypeUsage_Primitive__with_capacity(allocator, 16);
}
...
struct HashMap_usize_TypeUsage_Primitive HashMap_usize_TypeUsage_Primitive__with_capacity(struct trait_Allocator allocator, uintptr_t capacity) {
    ...
    struct HashMap_usize_TypeUsage_Primitive self = (struct HashMap_usize_TypeUsage_Primitive) {
        .allocator = allocator,
        .buckets = 0,
        .data = 0,
        .capacity = 0,
    ...
    HashMap_usize_TypeUsage_Primitive__resize(&self, capacity);
...
void HashMap_usize_TypeUsage_Primitive__resize(struct HashMap_usize_TypeUsage_Primitive* self, uintptr_t new_capacity) {
    ...
    self->buckets = self->allocator.vtable->fn_realloc(self->allocator.instance, self->buckets, new_capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Primitive*));
    #line 56 "src/std/HashMap.pv"
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, new_capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Primitive));
...
struct HashMap_usize_TypeUsage_Primitive HashMap_usize_TypeUsage_Primitive__clone(struct HashMap_usize_TypeUsage_Primitive* self, struct trait_Allocator allocator) {
    ...
    struct HashMap_usize_TypeUsage_Primitive other = (struct HashMap_usize_TypeUsage_Primitive) {
        ...
        .data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Primitive)),
        .length = self->length,
...
struct trait_Map_usize_TypeUsage_PrimitiveVTable HASH_MAP_USIZE_TYPE_USAGE_PRIMITIVE__VTABLE__MAP = { .fn_find = &HashMap_usize_TypeUsage_Primitive__Map_usize_TypeUsage_Primitive__find, .fn_insert = &HashMap_usize_TypeUsage_Primitive__Map_usize_TypeUsage_Primitive__insert, .fn_remove = &HashMap_usize_TypeUsage_Primitive__Map_usize_TypeUsage_Primitive__remove };
