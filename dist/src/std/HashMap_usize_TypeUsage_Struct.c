...
struct HashMap_usize_TypeUsage_Struct HashMap_usize_TypeUsage_Struct__new(struct Allocator allocator) {
    ...
    struct HashMap_usize_TypeUsage_Struct self = (struct HashMap_usize_TypeUsage_Struct) { .allocator = allocator };
...
struct TypeUsage_Struct* HashMap_usize_TypeUsage_Struct__insert(struct HashMap_usize_TypeUsage_Struct* self, uintptr_t key, struct TypeUsage_Struct value) {
    ...
    self->data[self->length] = (struct HashMapBucket_usize_TypeUsage_Struct) { .key = key, .value = value };
...
struct HashMap_usize_TypeUsage_Struct HashMap_usize_TypeUsage_Struct__clone(struct HashMap_usize_TypeUsage_Struct* self, struct Allocator allocator) {
    ...
    struct HashMap_usize_TypeUsage_Struct other = (struct HashMap_usize_TypeUsage_Struct) {
        ...
        .data = allocator.vtable->alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Struct)),
        .length = self->length,
