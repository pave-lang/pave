...
void HashMap_usize_TypeUsage_Struct__resize(struct HashMap_usize_TypeUsage_Struct* self, uintptr_t new_capacity) {
    ...
    self->buckets = self->allocator.vtable->fn_realloc(self->allocator.instance, self->buckets, new_capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Struct*));
    #line 56 "src/std/HashMap.pv"
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, new_capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Struct));
...
struct TypeUsage_Struct* HashMap_usize_TypeUsage_Struct__insert(struct HashMap_usize_TypeUsage_Struct* self, uintptr_t key, struct TypeUsage_Struct value) {
    ...
    struct HashMapBucket_usize_TypeUsage_Struct* bucket_node = *current_bucket_node;
...
struct HashMap_usize_TypeUsage_Struct HashMap_usize_TypeUsage_Struct__clone(struct HashMap_usize_TypeUsage_Struct* self, struct trait_Allocator allocator) {
    ...
    struct HashMap_usize_TypeUsage_Struct other = (struct HashMap_usize_TypeUsage_Struct) {
        ...
        .data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_usize_TypeUsage_Struct)),
        .length = self->length,
...
struct HashMapBucket_usize_TypeUsage_Struct* HashMap_usize_TypeUsage_Struct__Index__index(void* __self) {
    struct HashMap_usize_TypeUsage_Struct* self = __self; (void)self;
...
struct trait_Map_usize_TypeUsage_StructVTable HASH_MAP_USIZE_TYPE_USAGE_STRUCT__VTABLE__MAP = { .fn_find = &HashMap_usize_TypeUsage_Struct__Map_usize_TypeUsage_Struct__find, .fn_insert = &HashMap_usize_TypeUsage_Struct__Map_usize_TypeUsage_Struct__insert, .fn_remove = &HashMap_usize_TypeUsage_Struct__Map_usize_TypeUsage_Struct__remove };
