...
struct HashMap_str_ref_Namespace HashMap_str_ref_Namespace__new(struct trait_Allocator allocator) {
    ...
    struct HashMap_str_ref_Namespace self = (struct HashMap_str_ref_Namespace) { .allocator = allocator };

    #line 41 "src/std/HashMap.pv"
    HashMap_str_ref_Namespace__resize(&self, initial_capacity);
...
struct Namespace** HashMap_str_ref_Namespace__insert(struct HashMap_str_ref_Namespace* self, struct str key, struct Namespace* value) {
    ...
    self->data[self->length] = (struct HashMapBucket_str_ref_Namespace) { .key = key, .value = value };
