...
struct Array_EnumVariantParameter Array_EnumVariantParameter__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_EnumVariantParameter) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_EnumVariantParameter Array_EnumVariantParameter__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_EnumVariantParameter self = (struct Array_EnumVariantParameter) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
    #line 83 "src/std/Array.pv"
    Array_EnumVariantParameter__reserve(&self, length);
...
void Array_EnumVariantParameter__reserve(struct Array_EnumVariantParameter* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct EnumVariantParameter));
...
uintptr_t Array_EnumVariantParameter__append(struct Array_EnumVariantParameter* self, struct EnumVariantParameter value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_EnumVariantParameter__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_EnumVariantParameter__prepend(struct Array_EnumVariantParameter* self, struct EnumVariantParameter value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct EnumVariantParameter));
...
bool Array_EnumVariantParameter__remove_back(struct Array_EnumVariantParameter* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct EnumVariantParameter));
...
void Array_EnumVariantParameter__clear(struct Array_EnumVariantParameter* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct EnumVariantParameter));
...
struct Array_EnumVariantParameter Array_EnumVariantParameter__clone(struct Array_EnumVariantParameter* self, struct trait_Allocator allocator) {
    ...
    struct EnumVariantParameter* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct EnumVariantParameter));
    #line 174 "src/std/Array.pv"
    memcpy(data, self->data, self->length * sizeof(struct EnumVariantParameter));

    #line 176 "src/std/Array.pv"
    return (struct Array_EnumVariantParameter) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct EnumVariantParameter* Array_EnumVariantParameter__Index__index(void* __self) {
    struct Array_EnumVariantParameter* self = __self; (void)self;
