...
struct Array_DeferStatement Array_DeferStatement__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_DeferStatement) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_DeferStatement Array_DeferStatement__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_DeferStatement self = (struct Array_DeferStatement) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
struct DeferStatement* Array_DeferStatement__Index__index(void* __self) {
    struct Array_DeferStatement* self = __self; (void)self;
