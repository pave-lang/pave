...
struct Array_DeferStatement Array_DeferStatement__new(struct Allocator allocator) {
    #line 78 "src/std/Array.pv"
    return (struct Array_DeferStatement) { .allocator = allocator };
}

#line 81 "src/std/Array.pv"
struct Array_DeferStatement Array_DeferStatement__new_with_length(struct Allocator allocator, uintptr_t length) {
...
struct Array_DeferStatement Array_DeferStatement__new_with_capacity(struct Allocator allocator, uintptr_t length) {
...
struct Array_DeferStatement Array_DeferStatement__clone(struct Array_DeferStatement* self, struct Allocator allocator) {
