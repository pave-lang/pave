...
struct HashMap_usize_TypeUsage_Trait HashMap_usize_TypeUsage_Trait__new(struct Allocator allocator) {
    ...
    struct HashMap_usize_TypeUsage_Trait self = (struct HashMap_usize_TypeUsage_Trait) { .allocator = allocator };

    #line 41 "src/std/HashMap.pv"
    HashMap_usize_TypeUsage_Trait__resize(&self, initial_capacity);
...
struct TypeUsage_Trait* HashMap_usize_TypeUsage_Trait__insert(struct HashMap_usize_TypeUsage_Trait* self, uintptr_t key, struct TypeUsage_Trait value) {
    ...
    self->data[self->length] = (struct HashMapBucket_usize_TypeUsage_Trait) { .key = key, .value = value };
