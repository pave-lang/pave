...
void Array_Type__reserve(struct Array_Type* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->realloc(self->allocator.instance, self->data, capacity * sizeof(struct Type));
...
struct Array_Type Array_Type__clone(struct Array_Type* self, struct trait_Allocator allocator) {
    ...
    struct Type* data = allocator.vtable->alloc(allocator.instance, self->capacity * sizeof(struct Type));
