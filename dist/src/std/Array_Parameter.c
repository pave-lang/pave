...
struct Array_Parameter Array_Parameter__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_Parameter) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_Parameter Array_Parameter__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_Parameter self = (struct Array_Parameter) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_Parameter__reserve(struct Array_Parameter* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct Parameter));
...
struct Array_Parameter Array_Parameter__clone(struct Array_Parameter* self, struct trait_Allocator allocator) {
    ...
    struct Parameter* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct Parameter));
