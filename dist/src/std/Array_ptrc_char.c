...
void Array_ptrc_char__reserve(struct Array_ptrc_char* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->realloc(self->allocator.instance, self->data, capacity * sizeof(char const*));
...
struct ArrayIter_ref_ptrc_char Array_ptrc_char__iter(struct Array_ptrc_char* self) {
    ...
    return ArrayIter_ref_ptrc_char__new((void*)(self->data), (void*)(self->data + self->length));
}
