...
struct Array_CompletionInfo Array_CompletionInfo__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_CompletionInfo) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_CompletionInfo Array_CompletionInfo__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_CompletionInfo self = (struct Array_CompletionInfo) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
    #line 83 "src/std/Array.pv"
    Array_CompletionInfo__reserve(&self, length);
...
void Array_CompletionInfo__reserve(struct Array_CompletionInfo* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct CompletionInfo));
...
uintptr_t Array_CompletionInfo__append(struct Array_CompletionInfo* self, struct CompletionInfo value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_CompletionInfo__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_CompletionInfo__prepend(struct Array_CompletionInfo* self, struct CompletionInfo value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct CompletionInfo));
...
bool Array_CompletionInfo__remove_back(struct Array_CompletionInfo* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct CompletionInfo));
...
void Array_CompletionInfo__clear(struct Array_CompletionInfo* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct CompletionInfo));
...
struct Array_CompletionInfo Array_CompletionInfo__clone(struct Array_CompletionInfo* self, struct trait_Allocator allocator) {
    ...
    struct CompletionInfo* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct CompletionInfo));
    #line 174 "src/std/Array.pv"
    memcpy(data, self->data, self->length * sizeof(struct CompletionInfo));

    #line 176 "src/std/Array.pv"
    return (struct Array_CompletionInfo) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct slice_CompletionInfo Array_CompletionInfo__as_slice(struct Array_CompletionInfo* self) {
    ...
    return (struct slice_CompletionInfo) { .data = self->data, .length = self->length };
}

#line 195 "src/std/Array.pv"
struct CompletionInfo* Array_CompletionInfo__Index__index(void* __self) {
    struct Array_CompletionInfo* self = __self; (void)self;
