...
struct Array_ref_GenericMap Array_ref_GenericMap__new(struct trait_Allocator allocator) {
    #line 78 "src/std/Array.pv"
    return (struct Array_ref_GenericMap) { .allocator = allocator };
}

#line 81 "src/std/Array.pv"
struct Array_ref_GenericMap Array_ref_GenericMap__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    #line 82 "src/std/Array.pv"
    struct Array_ref_GenericMap self = (struct Array_ref_GenericMap) { .allocator = allocator };
    #line 83 "src/std/Array.pv"
    Array_ref_GenericMap__reserve(&self, length);
...
struct Array_ref_GenericMap Array_ref_GenericMap__new_with_capacity(struct trait_Allocator allocator, uintptr_t length) {
...
void Array_ref_GenericMap__reserve(struct Array_ref_GenericMap* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->realloc(self->allocator.instance, self->data, capacity * sizeof(struct GenericMap*));
...
uintptr_t Array_ref_GenericMap__append(struct Array_ref_GenericMap* self, struct GenericMap* value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_ref_GenericMap__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_ref_GenericMap__prepend(struct Array_ref_GenericMap* self, struct GenericMap* value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct GenericMap*));
...
bool Array_ref_GenericMap__remove_back(struct Array_ref_GenericMap* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct GenericMap*));
...
void Array_ref_GenericMap__clear(struct Array_ref_GenericMap* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct GenericMap*));
...
struct Array_ref_GenericMap Array_ref_GenericMap__clone(struct Array_ref_GenericMap* self, struct trait_Allocator allocator) {
    #line 173 "src/std/Array.pv"
    struct GenericMap** data = allocator.vtable->alloc(allocator.instance, self->capacity * sizeof(struct GenericMap*));
    #line 174 "src/std/Array.pv"
    memcpy(data, self->data, self->length * sizeof(struct GenericMap*));

    #line 176 "src/std/Array.pv"
    return (struct Array_ref_GenericMap) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct Iter_ref_ref_GenericMap Array_ref_GenericMap__iter(struct Array_ref_GenericMap* self) {
