...
struct HashMap_str_Function HashMap_str_Function__new(struct trait_Allocator allocator) {
    ...
    return HashMap_str_Function__with_capacity(allocator, 16);
}
...
struct HashMap_str_Function HashMap_str_Function__with_capacity(struct trait_Allocator allocator, uintptr_t capacity) {
    ...
    struct HashMap_str_Function self = (struct HashMap_str_Function) {
        .allocator = allocator,
        .buckets = 0,
        .data = 0,
        .capacity = 0,
    ...
    HashMap_str_Function__resize(&self, capacity);
...
void HashMap_str_Function__resize(struct HashMap_str_Function* self, uintptr_t new_capacity) {
    ...
    self->buckets = self->allocator.vtable->fn_realloc(self->allocator.instance, self->buckets, new_capacity * sizeof(struct HashMapBucket_str_Function*));
    #line 56 "src/std/HashMap.pv"
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, new_capacity * sizeof(struct HashMapBucket_str_Function));
    #line 57 "src/std/HashMap.pv"
    self->capacity = new_capacity;
    #line 58 "src/std/HashMap.pv"
    HashMap_str_Function__fill_buckets(self);
}
...
struct Function* HashMap_str_Function__find(struct HashMap_str_Function* self, struct str* key) {
    ...
    struct HashMapBucket_str_Function* current_bucket_node = self->buckets[bucket_index];
...
struct Function* HashMap_str_Function__insert(struct HashMap_str_Function* self, struct str key, struct Function value) {
    ...
    struct Function* existing_value = HashMap_str_Function__find(self, &key);
    ...
    struct HashMapBucket_str_Function* bucket_node = *current_bucket_node;
    ...
    self->data[self->length] = (struct HashMapBucket_str_Function) { .key = key, .value = value, .next = 0 };
    #line 100 "src/std/HashMap.pv"
    struct HashMapBucket_str_Function* data = self->data + self->length;
...
bool HashMap_str_Function__remove(struct HashMap_str_Function* self, struct str* key) {
    ...
    while (current_bucket_node != 0) {
        ...
        if (u64__Eq_u64__eq(str__Hash__hash(&current_bucket_node->key), hash) && str__Eq_str__eq(current_bucket_node->key, *key)) {
            ...
            struct HashMapBucket_str_Function* last = self->data + self->length - 1;
...
struct HashMap_str_Function HashMap_str_Function__clone(struct HashMap_str_Function* self, struct trait_Allocator allocator) {
    ...
    struct HashMap_str_Function other = (struct HashMap_str_Function) {
        .allocator = allocator,
        .buckets = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(self->data)),
        .data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_str_Function)),
        .length = self->length,
        .capacity = self->capacity,
    };
    #line 170 "src/std/HashMap.pv"
    memcpy(other.data, self->data, self->capacity * sizeof(struct HashMapBucket_str_Function));
    #line 171 "src/std/HashMap.pv"
    HashMap_str_Function__fill_buckets(&other);
...
struct HashMapIter_str_Function HashMap_str_Function__iter(struct HashMap_str_Function* self) {
    ...
    return (struct HashMapIter_str_Function) {
        .iter = self->data - 1,
...
void HashMap_str_Function__clear(struct HashMap_str_Function* self) {
    ...
    memset(self->data, 0, self->capacity * sizeof(struct HashMapBucket_str_Function));
...
struct HashMapBucket_str_Function* HashMap_str_Function__Index__index(void* __self) {
    struct HashMap_str_Function* self = __self; (void)self;
    #line 193 "src/std/HashMap.pv"
    return self->data;
}

#line 198 "src/std/HashMap.pv"
struct Function* HashMap_str_Function__Map_str_Function__find(void* __self, struct str* key) {
    struct HashMap_str_Function* self = __self; (void)self;
...
struct Function* HashMap_str_Function__Map_str_Function__insert(void* __self, struct str key, struct Function value) {
    struct HashMap_str_Function* self = __self; (void)self;
...
bool HashMap_str_Function__Map_str_Function__remove(void* __self, struct str* key) {
    struct HashMap_str_Function* self = __self; (void)self;
...
struct trait_Map_str_FunctionVTable HASH_MAP_STR_FUNCTION__VTABLE__MAP = { .fn_find = &HashMap_str_Function__Map_str_Function__find, .fn_insert = &HashMap_str_Function__Map_str_Function__insert, .fn_remove = &HashMap_str_Function__Map_str_Function__remove };
