...
struct Array_ref_Trait Array_ref_Trait__new(struct Allocator allocator) {
    #line 78 "src/std/Array.pv"
    return (struct Array_ref_Trait) { .allocator = allocator };
}

#line 81 "src/std/Array.pv"
struct Array_ref_Trait Array_ref_Trait__new_with_length(struct Allocator allocator, uintptr_t length) {
    #line 82 "src/std/Array.pv"
    struct Array_ref_Trait self = (struct Array_ref_Trait) { .allocator = allocator };
    #line 83 "src/std/Array.pv"
    Array_ref_Trait__reserve(&self, length);
...
struct Array_ref_Trait Array_ref_Trait__new_with_capacity(struct Allocator allocator, uintptr_t length) {
...
void Array_ref_Trait__reserve(struct Array_ref_Trait* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->realloc(self->allocator.instance, self->data, capacity * sizeof(struct Trait*));
...
uintptr_t Array_ref_Trait__append(struct Array_ref_Trait* self, struct Trait* value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_ref_Trait__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_ref_Trait__prepend(struct Array_ref_Trait* self, struct Trait* value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct Trait*));
...
bool Array_ref_Trait__remove_back(struct Array_ref_Trait* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct Trait*));
...
void Array_ref_Trait__clear(struct Array_ref_Trait* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct Trait*));
...
struct Array_ref_Trait Array_ref_Trait__clone(struct Array_ref_Trait* self, struct Allocator allocator) {
    #line 173 "src/std/Array.pv"
    struct Trait** data = allocator.vtable->alloc(allocator.instance, self->capacity * sizeof(struct Trait*));
    #line 174 "src/std/Array.pv"
    memcpy(data, self->data, self->length * sizeof(struct Trait*));

    #line 176 "src/std/Array.pv"
    return (struct Array_ref_Trait) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct ArrayIter_ref_ref_Trait Array_ref_Trait__iter(struct Array_ref_Trait* self) {
    #line 186 "src/std/Array.pv"
    return ArrayIter_ref_ref_Trait__new((void*)(self->data), (void*)(self->data + self->length));
}

#line 189 "src/std/Array.pv"
struct slice_ref_Trait Array_ref_Trait__as_slice(struct Array_ref_Trait* self) {
    #line 190 "src/std/Array.pv"
    return (struct slice_ref_Trait) { .data = self->data + 0, .length = self->length - 0 };
}
