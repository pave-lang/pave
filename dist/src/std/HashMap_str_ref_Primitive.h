#ifndef PAVE_HASH_MAP_STR_REF_PRIMITIVE
#define PAVE_HASH_MAP_STR_REF_PRIMITIVE
...
struct HashMap_str_ref_Primitive {
    ...
    struct HashMapBucket_str_ref_Primitive** buckets;
    struct HashMapBucket_str_ref_Primitive* data;
    uintptr_t capacity;
    uintptr_t length;
};
...
extern struct trait_Map_str_ref_PrimitiveVTable HASH_MAP_STR_REF_PRIMITIVE__VTABLE__MAP;
