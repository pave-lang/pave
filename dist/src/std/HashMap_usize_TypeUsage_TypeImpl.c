...
struct HashMap_usize_TypeUsage_TypeImpl HashMap_usize_TypeUsage_TypeImpl__new(struct trait_Allocator allocator) {
    ...
    return HashMap_usize_TypeUsage_TypeImpl__with_capacity(allocator, 16);
}
...
struct HashMap_usize_TypeUsage_TypeImpl HashMap_usize_TypeUsage_TypeImpl__with_capacity(struct trait_Allocator allocator, uintptr_t capacity) {
    ...
    struct HashMap_usize_TypeUsage_TypeImpl self = (struct HashMap_usize_TypeUsage_TypeImpl) {
        .allocator = allocator,
        .buckets = 0,
        .data = 0,
        .capacity = 0,
    ...
    HashMap_usize_TypeUsage_TypeImpl__resize(&self, capacity);
...
void HashMap_usize_TypeUsage_TypeImpl__resize(struct HashMap_usize_TypeUsage_TypeImpl* self, uintptr_t new_capacity) {
    ...
    self->buckets = self->allocator.vtable->fn_realloc(self->allocator.instance, self->buckets, new_capacity * sizeof(struct HashMapBucket_usize_TypeUsage_TypeImpl*));
    #line 56 "src/std/HashMap.pv"
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, new_capacity * sizeof(struct HashMapBucket_usize_TypeUsage_TypeImpl));
    #line 57 "src/std/HashMap.pv"
    self->capacity = new_capacity;
    #line 58 "src/std/HashMap.pv"
    HashMap_usize_TypeUsage_TypeImpl__fill_buckets(self);
}
...
struct TypeUsage_TypeImpl* HashMap_usize_TypeUsage_TypeImpl__find(struct HashMap_usize_TypeUsage_TypeImpl* self, uintptr_t* key) {
    ...
    struct HashMapBucket_usize_TypeUsage_TypeImpl* current_bucket_node = self->buckets[bucket_index];
...
struct TypeUsage_TypeImpl* HashMap_usize_TypeUsage_TypeImpl__insert(struct HashMap_usize_TypeUsage_TypeImpl* self, uintptr_t key, struct TypeUsage_TypeImpl value) {
    ...
    struct TypeUsage_TypeImpl* existing_value = HashMap_usize_TypeUsage_TypeImpl__find(self, &key);
    ...
    if (usize__Eq_usize__eq(self->capacity, 0) || (self->length * 100 / self->capacity) > 75) {
        ...
        HashMap_usize_TypeUsage_TypeImpl__resize(self, self->capacity * 2);
    }
    ...
    struct HashMapBucket_usize_TypeUsage_TypeImpl* bucket_node = *current_bucket_node;
    ...
    self->data[self->length] = (struct HashMapBucket_usize_TypeUsage_TypeImpl) { .key = key, .value = value, .next = 0 };
    #line 100 "src/std/HashMap.pv"
    struct HashMapBucket_usize_TypeUsage_TypeImpl* data = self->data + self->length;
...
bool HashMap_usize_TypeUsage_TypeImpl__remove(struct HashMap_usize_TypeUsage_TypeImpl* self, uintptr_t* key) {
    ...
    while (current_bucket_node != 0) {
        ...
        if (u64__Eq_u64__eq(usize__Hash__hash(&current_bucket_node->key), hash) && usize__Eq_usize__eq(current_bucket_node->key, *key)) {
            ...
            struct HashMapBucket_usize_TypeUsage_TypeImpl* last = self->data + self->length - 1;
...
void HashMap_usize_TypeUsage_TypeImpl__fill_buckets(struct HashMap_usize_TypeUsage_TypeImpl* self) {
    ...
    memset(self->buckets, 0, self->capacity * sizeof(struct HashMapBucket_usize_TypeUsage_TypeImpl*));

    #line 144 "src/std/HashMap.pv"
    for (uintptr_t i = 0; i != self->length; i < self->length ? i++ : i--) {
        #line 145 "src/std/HashMap.pv"
        struct HashMapBucket_usize_TypeUsage_TypeImpl* node = self->data + i;
...
struct HashMap_usize_TypeUsage_TypeImpl HashMap_usize_TypeUsage_TypeImpl__clone(struct HashMap_usize_TypeUsage_TypeImpl* self, struct trait_Allocator allocator) {
    ...
    struct HashMap_usize_TypeUsage_TypeImpl other = (struct HashMap_usize_TypeUsage_TypeImpl) {
        .allocator = allocator,
        .buckets = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(self->data)),
        .data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_usize_TypeUsage_TypeImpl)),
        .length = self->length,
        .capacity = self->capacity,
    };
    #line 170 "src/std/HashMap.pv"
    memcpy(other.data, self->data, self->capacity * sizeof(struct HashMapBucket_usize_TypeUsage_TypeImpl));
    #line 171 "src/std/HashMap.pv"
    HashMap_usize_TypeUsage_TypeImpl__fill_buckets(&other);
...
struct HashMapIter_usize_TypeUsage_TypeImpl HashMap_usize_TypeUsage_TypeImpl__iter(struct HashMap_usize_TypeUsage_TypeImpl* self) {
    ...
    return (struct HashMapIter_usize_TypeUsage_TypeImpl) {
        .iter = self->data - 1,
...
void HashMap_usize_TypeUsage_TypeImpl__clear(struct HashMap_usize_TypeUsage_TypeImpl* self) {
    ...
    memset(self->data, 0, self->capacity * sizeof(struct HashMapBucket_usize_TypeUsage_TypeImpl));
...
struct HashMapBucket_usize_TypeUsage_TypeImpl* HashMap_usize_TypeUsage_TypeImpl__Index__index(void* __self) {
    struct HashMap_usize_TypeUsage_TypeImpl* self = __self; (void)self;
...
struct trait_Map_usize_TypeUsage_TypeImplVTable HASH_MAP_USIZE_TYPE_USAGE_TYPE_IMPL__VTABLE__MAP = { .fn_find = &HashMap_usize_TypeUsage_TypeImpl__Map_usize_TypeUsage_TypeImpl__find, .fn_insert = &HashMap_usize_TypeUsage_TypeImpl__Map_usize_TypeUsage_TypeImpl__insert, .fn_remove = &HashMap_usize_TypeUsage_TypeImpl__Map_usize_TypeUsage_TypeImpl__remove };
