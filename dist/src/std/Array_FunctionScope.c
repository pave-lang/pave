...
struct Array_FunctionScope Array_FunctionScope__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_FunctionScope) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_FunctionScope Array_FunctionScope__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_FunctionScope self = (struct Array_FunctionScope) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_FunctionScope__reserve(struct Array_FunctionScope* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct FunctionScope));
...
struct Array_FunctionScope Array_FunctionScope__clone(struct Array_FunctionScope* self, struct trait_Allocator allocator) {
    ...
    struct FunctionScope* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct FunctionScope));
