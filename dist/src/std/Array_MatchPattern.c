...
struct Array_MatchPattern Array_MatchPattern__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_MatchPattern) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_MatchPattern Array_MatchPattern__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_MatchPattern self = (struct Array_MatchPattern) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_MatchPattern__reserve(struct Array_MatchPattern* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct MatchPattern));
...
struct Array_MatchPattern Array_MatchPattern__clone(struct Array_MatchPattern* self, struct trait_Allocator allocator) {
    ...
    struct MatchPattern* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct MatchPattern));
