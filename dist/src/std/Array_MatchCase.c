...
struct Array_MatchCase Array_MatchCase__new(struct Allocator allocator) {
    #line 78 "src/std/Array.pv"
    return (struct Array_MatchCase) { .allocator = allocator };
}

#line 81 "src/std/Array.pv"
struct Array_MatchCase Array_MatchCase__new_with_length(struct Allocator allocator, uintptr_t length) {
    #line 82 "src/std/Array.pv"
    struct Array_MatchCase self = (struct Array_MatchCase) { .allocator = allocator };
    #line 83 "src/std/Array.pv"
    Array_MatchCase__reserve(&self, length);
...
struct Array_MatchCase Array_MatchCase__new_with_capacity(struct Allocator allocator, uintptr_t length) {
...
void Array_MatchCase__reserve(struct Array_MatchCase* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->realloc(self->allocator.instance, self->data, capacity * sizeof(struct MatchCase));
...
uintptr_t Array_MatchCase__append(struct Array_MatchCase* self, struct MatchCase value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_MatchCase__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_MatchCase__prepend(struct Array_MatchCase* self, struct MatchCase value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct MatchCase));
...
bool Array_MatchCase__remove_back(struct Array_MatchCase* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct MatchCase));
...
void Array_MatchCase__clear(struct Array_MatchCase* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct MatchCase));
...
struct Array_MatchCase Array_MatchCase__clone(struct Array_MatchCase* self, struct Allocator allocator) {
    #line 173 "src/std/Array.pv"
    struct MatchCase* data = allocator.vtable->alloc(allocator.instance, self->capacity * sizeof(struct MatchCase));
    #line 174 "src/std/Array.pv"
    memcpy(data, self->data, self->length * sizeof(struct MatchCase));

    #line 176 "src/std/Array.pv"
    return (struct Array_MatchCase) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct ArrayIter_ref_MatchCase Array_MatchCase__iter(struct Array_MatchCase* self) {
    ...
    return ArrayIter_ref_MatchCase__new((void*)(self->data), (void*)(self->data + self->length));
}
