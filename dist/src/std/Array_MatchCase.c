...
struct Array_MatchCase Array_MatchCase__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_MatchCase) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_MatchCase Array_MatchCase__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_MatchCase self = (struct Array_MatchCase) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_MatchCase__reserve(struct Array_MatchCase* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct MatchCase));
...
struct Array_MatchCase Array_MatchCase__clone(struct Array_MatchCase* self, struct trait_Allocator allocator) {
    ...
    struct MatchCase* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct MatchCase));
...
struct MatchCase* Array_MatchCase__Index__index(void* __self) {
    struct Array_MatchCase* self = __self; (void)self;
