...
struct HashMap_str_ref_ImplConst HashMap_str_ref_ImplConst__new(struct trait_Allocator allocator) {
    ...
    struct HashMap_str_ref_ImplConst self = (struct HashMap_str_ref_ImplConst) { .allocator = allocator };

    #line 41 "src/std/HashMap.pv"
    HashMap_str_ref_ImplConst__resize(&self, initial_capacity);
...
struct ImplConst** HashMap_str_ref_ImplConst__insert(struct HashMap_str_ref_ImplConst* self, struct str key, struct ImplConst* value) {
    ...
    self->data[self->length] = (struct HashMapBucket_str_ref_ImplConst) { .key = key, .value = value };
