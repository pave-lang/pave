...
struct Array_DestructureBinding Array_DestructureBinding__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_DestructureBinding) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_DestructureBinding Array_DestructureBinding__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_DestructureBinding self = (struct Array_DestructureBinding) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
    #line 83 "src/std/Array.pv"
    Array_DestructureBinding__reserve(&self, length);
...
void Array_DestructureBinding__reserve(struct Array_DestructureBinding* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct DestructureBinding));
...
uintptr_t Array_DestructureBinding__append(struct Array_DestructureBinding* self, struct DestructureBinding value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_DestructureBinding__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_DestructureBinding__prepend(struct Array_DestructureBinding* self, struct DestructureBinding value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct DestructureBinding));
...
bool Array_DestructureBinding__remove_back(struct Array_DestructureBinding* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct DestructureBinding));
...
void Array_DestructureBinding__clear(struct Array_DestructureBinding* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct DestructureBinding));
...
struct Array_DestructureBinding Array_DestructureBinding__clone(struct Array_DestructureBinding* self, struct trait_Allocator allocator) {
    ...
    struct DestructureBinding* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct DestructureBinding));
    #line 174 "src/std/Array.pv"
    memcpy(data, self->data, self->length * sizeof(struct DestructureBinding));

    #line 176 "src/std/Array.pv"
    return (struct Array_DestructureBinding) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct slice_DestructureBinding Array_DestructureBinding__as_slice(struct Array_DestructureBinding* self) {
    ...
    return (struct slice_DestructureBinding) { .data = self->data, .length = self->length };
}

#line 195 "src/std/Array.pv"
struct DestructureBinding* Array_DestructureBinding__Index__index(void* __self) {
    struct Array_DestructureBinding* self = __self; (void)self;
