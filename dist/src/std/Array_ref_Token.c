...
struct Array_ref_Token Array_ref_Token__new(struct Allocator allocator) {
    #line 78 "src/std/Array.pv"
    return (struct Array_ref_Token) { .allocator = allocator };
}

#line 81 "src/std/Array.pv"
struct Array_ref_Token Array_ref_Token__new_with_length(struct Allocator allocator, uintptr_t length) {
    #line 82 "src/std/Array.pv"
    struct Array_ref_Token self = (struct Array_ref_Token) { .allocator = allocator };
    #line 83 "src/std/Array.pv"
    Array_ref_Token__reserve(&self, length);
...
struct Array_ref_Token Array_ref_Token__new_with_capacity(struct Allocator allocator, uintptr_t length) {
...
void Array_ref_Token__reserve(struct Array_ref_Token* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->realloc(self->allocator.instance, self->data, capacity * sizeof(struct Token*));
...
uintptr_t Array_ref_Token__append(struct Array_ref_Token* self, struct Token* value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_ref_Token__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_ref_Token__prepend(struct Array_ref_Token* self, struct Token* value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct Token*));
...
bool Array_ref_Token__remove_back(struct Array_ref_Token* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct Token*));
...
void Array_ref_Token__clear(struct Array_ref_Token* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct Token*));
...
struct Array_ref_Token Array_ref_Token__clone(struct Array_ref_Token* self, struct Allocator allocator) {
    ...
    memcpy(data, self->data, self->length * sizeof(struct Token*));

    #line 176 "src/std/Array.pv"
    return (struct Array_ref_Token) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct ArrayIter_ref_ref_Token Array_ref_Token__iter(struct Array_ref_Token* self) {
    #line 186 "src/std/Array.pv"
    return ArrayIter_ref_ref_Token__new((void*)(self->data), (void*)(self->data + self->length));
}

#line 189 "src/std/Array.pv"
struct slice_ref_Token Array_ref_Token__as_slice(struct Array_ref_Token* self) {
    #line 190 "src/std/Array.pv"
    return (struct slice_ref_Token) { .data = self->data + 0, .length = self->length - 0 };
}
