...
struct HashMap_str_Array_InlayHint HashMap_str_Array_InlayHint__new(struct Allocator allocator) {
    ...
    struct HashMap_str_Array_InlayHint self = (struct HashMap_str_Array_InlayHint) { .allocator = allocator };

    #line 41 "src/std/HashMap.pv"
    HashMap_str_Array_InlayHint__resize(&self, initial_capacity);
...
struct Array_InlayHint* HashMap_str_Array_InlayHint__insert(struct HashMap_str_Array_InlayHint* self, struct str key, struct Array_InlayHint value) {
    ...
    self->data[self->length] = (struct HashMapBucket_str_Array_InlayHint) { .key = key, .value = value };
