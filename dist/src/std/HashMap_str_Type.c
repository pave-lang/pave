...
struct trait_Map_str_TypeVTable HASH_MAP_STR_TYPE__VTABLE__MAP = { .fn_find = &HashMap_str_Type__Map_str_Type__find, .fn_insert = &HashMap_str_Type__Map_str_Type__insert, .fn_remove = &HashMap_str_Type__Map_str_Type__remove };
