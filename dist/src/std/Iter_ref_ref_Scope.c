...
struct Iter_ref_ref_Scope Iter_ref_ref_Scope__new(struct Scope** start, struct Scope** end) {
    ...
    return (struct Iter_ref_ref_Scope) {
        .step = 1,
        .iter = start - 1,
        .start = start,
        .end = end,
...
struct Iter_ref_ref_Scope Iter_ref_ref_Scope__reverse(struct Iter_ref_ref_Scope self) {
...
struct Iter_ref_ref_Scope Iter_ref_ref_Scope__skip(struct Iter_ref_ref_Scope self, intptr_t steps) {
...
bool Iter_ref_ref_Scope__next(struct Iter_ref_ref_Scope* self) {
...
struct Scope** Iter_ref_ref_Scope__value(struct Iter_ref_ref_Scope* self) {
    #line 44 "src/std/Array.pv"
    return self->iter;
}

#line 47 "src/std/Array.pv"
struct IterEnumerate_ref_ref_Scope Iter_ref_ref_Scope__enumerate(struct Iter_ref_ref_Scope self) {
    #line 48 "src/std/Array.pv"
    return (struct IterEnumerate_ref_ref_Scope) { .index = 0, .iter = self };
}
