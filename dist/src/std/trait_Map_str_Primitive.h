#ifndef PAVE_TRAIT_MAP_STR_PRIMITIVE
#define PAVE_TRAIT_MAP_STR_PRIMITIVE
...
struct trait_Map_str_PrimitiveVTable {
...
#line 1 "src/std/Map.pv"
struct trait_Map_str_Primitive {
    const struct trait_Map_str_PrimitiveVTable* vtable;
    void* instance;
};
