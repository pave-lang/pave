...
bool IterEnumerate_ref_ref_Impl__next(struct IterEnumerate_ref_ref_Impl* self) {
    ...
    if (!ArrayIter_ref_ref_Impl__next(&self->iter)) {
        #line 59 "src/std/Array.pv"
        return false;
    }
...
struct tuple_usize_ref_ref_Impl IterEnumerate_ref_ref_Impl__value(struct IterEnumerate_ref_ref_Impl* self) {
    #line 65 "src/std/Array.pv"
    return (struct tuple_usize_ref_ref_Impl) { ._0 = self->index - 1, ._1 = ArrayIter_ref_ref_Impl__value(&self->iter) };
}
