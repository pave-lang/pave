...
struct HashMap_str_Enum HashMap_str_Enum__new(struct trait_Allocator allocator) {
    ...
    return HashMap_str_Enum__with_capacity(allocator, 16);
}

#line 39 "src/std/HashMap.pv"
struct HashMap_str_Enum HashMap_str_Enum__with_capacity(struct trait_Allocator allocator, uintptr_t capacity) {
    #line 40 "src/std/HashMap.pv"
    struct HashMap_str_Enum self = (struct HashMap_str_Enum) {
        .allocator = allocator,
        .buckets = 0,
        .data = 0,
        .capacity = 0,
    ...
    HashMap_str_Enum__resize(&self, capacity);
...
struct Enum* HashMap_str_Enum__insert(struct HashMap_str_Enum* self, struct str key, struct Enum value) {
    ...
    self->data[self->length] = (struct HashMapBucket_str_Enum) { .key = key, .value = value, .next = 0 };
