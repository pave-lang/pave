...
struct Iter_ptrc_char Iter_ptrc_char__reverse(struct Iter_ptrc_char self) {
...
struct Iter_ptrc_char Iter_ptrc_char__skip(struct Iter_ptrc_char self, intptr_t steps) {
...
bool Iter_ptrc_char__next(struct Iter_ptrc_char* self) {
...
char const* Iter_ptrc_char__value(struct Iter_ptrc_char* self) {
    #line 44 "src/std/Array.pv"
    return self->iter;
}

#line 47 "src/std/Array.pv"
struct IterEnumerate_ptrc_char Iter_ptrc_char__enumerate(struct Iter_ptrc_char self) {
    #line 48 "src/std/Array.pv"
    return (struct IterEnumerate_ptrc_char) { .index = 0, .iter = self };
}
