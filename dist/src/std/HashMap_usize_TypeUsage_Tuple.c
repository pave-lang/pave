...
struct HashMap_usize_TypeUsage_Tuple HashMap_usize_TypeUsage_Tuple__new(struct trait_Allocator allocator) {
    ...
    struct HashMap_usize_TypeUsage_Tuple self = (struct HashMap_usize_TypeUsage_Tuple) { .allocator = allocator };

    #line 41 "src/std/HashMap.pv"
    HashMap_usize_TypeUsage_Tuple__resize(&self, initial_capacity);
...
struct TypeUsage_Tuple* HashMap_usize_TypeUsage_Tuple__insert(struct HashMap_usize_TypeUsage_Tuple* self, uintptr_t key, struct TypeUsage_Tuple value) {
    ...
    self->data[self->length] = (struct HashMapBucket_usize_TypeUsage_Tuple) { .key = key, .value = value };
