...
struct Array_Statement Array_Statement__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_Statement) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_Statement Array_Statement__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_Statement self = (struct Array_Statement) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_Statement__reserve(struct Array_Statement* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct Statement));
...
struct Array_Statement Array_Statement__clone(struct Array_Statement* self, struct trait_Allocator allocator) {
    ...
    struct Statement* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct Statement));
...
struct Statement* Array_Statement__Index__index(void* __self) {
    struct Array_Statement* self = __self; (void)self;
