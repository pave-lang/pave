...
struct ArrayIter_ref_Impl Array_Impl__iter(struct Array_Impl* self) {
    ...
    return ArrayIter_ref_Impl__new((void*)(self->data), (void*)(self->data + self->length));
}
