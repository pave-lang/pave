...
struct Array_Impl Array_Impl__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_Impl) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_Impl Array_Impl__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_Impl self = (struct Array_Impl) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
    #line 83 "src/std/Array.pv"
    Array_Impl__reserve(&self, length);
...
uintptr_t Array_Impl__append(struct Array_Impl* self, struct Impl value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_Impl__reserve(self, self->capacity + additional_capacity);
    }
...
struct Impl* Array_Impl__Index__index(void* __self) {
    struct Array_Impl* self = __self; (void)self;
