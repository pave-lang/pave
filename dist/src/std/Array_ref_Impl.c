...
struct Array_ref_Impl Array_ref_Impl__new(struct Allocator allocator) {
    #line 78 "src/std/Array.pv"
    return (struct Array_ref_Impl) { .allocator = allocator };
}

#line 81 "src/std/Array.pv"
struct Array_ref_Impl Array_ref_Impl__new_with_length(struct Allocator allocator, uintptr_t length) {
    #line 82 "src/std/Array.pv"
    struct Array_ref_Impl self = (struct Array_ref_Impl) { .allocator = allocator };
    #line 83 "src/std/Array.pv"
    Array_ref_Impl__reserve(&self, length);
...
struct Array_ref_Impl Array_ref_Impl__new_with_capacity(struct Allocator allocator, uintptr_t length) {
...
void Array_ref_Impl__reserve(struct Array_ref_Impl* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->realloc(self->allocator.instance, self->data, capacity * sizeof(struct Impl*));
...
uintptr_t Array_ref_Impl__append(struct Array_ref_Impl* self, struct Impl* value) {
    ...
    if (self->capacity <= self->length + 1) {
        ...
        Array_ref_Impl__reserve(self, self->capacity + additional_capacity);
    }
...
uintptr_t Array_ref_Impl__prepend(struct Array_ref_Impl* self, struct Impl* value) {
    ...
    memmove(self->data + 1, self->data, self->length * sizeof(struct Impl*));
...
bool Array_ref_Impl__remove_back(struct Array_ref_Impl* self) {
    ...
    memset(self->data + self->length, 0, sizeof(struct Impl*));
...
void Array_ref_Impl__clear(struct Array_ref_Impl* self) {
    ...
    memset(self->data, 0, self->length * sizeof(struct Impl*));
...
struct Array_ref_Impl Array_ref_Impl__clone(struct Array_ref_Impl* self, struct Allocator allocator) {
    #line 173 "src/std/Array.pv"
    struct Impl** data = allocator.vtable->alloc(allocator.instance, self->capacity * sizeof(struct Impl*));
    #line 174 "src/std/Array.pv"
    memcpy(data, self->data, self->length * sizeof(struct Impl*));

    #line 176 "src/std/Array.pv"
    return (struct Array_ref_Impl) {
        .allocator = allocator,
        .data = data,
        .length = self->length,
...
struct ArrayIter_ref_ref_Impl Array_ref_Impl__iter(struct Array_ref_Impl* self) {
    #line 186 "src/std/Array.pv"
    return ArrayIter_ref_ref_Impl__new((void*)(self->data), (void*)(self->data + self->length));
}

#line 189 "src/std/Array.pv"
struct slice_ref_Impl Array_ref_Impl__as_slice(struct Array_ref_Impl* self) {
    #line 190 "src/std/Array.pv"
    return (struct slice_ref_Impl) { .data = self->data + 0, .length = self->length - 0 };
}
