...
struct Array_ref_Impl Array_ref_Impl__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_ref_Impl) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_ref_Impl Array_ref_Impl__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_ref_Impl self = (struct Array_ref_Impl) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_ref_Impl__reserve(struct Array_ref_Impl* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct Impl*));
...
struct Array_ref_Impl Array_ref_Impl__clone(struct Array_ref_Impl* self, struct trait_Allocator allocator) {
    ...
    struct Impl** data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct Impl*));
...
struct Iter_ref_ref_Impl Array_ref_Impl__iter(struct Array_ref_Impl* self) {
    ...
    return Iter_ref_ref_Impl__new(self->data, self->data + self->length);
}
