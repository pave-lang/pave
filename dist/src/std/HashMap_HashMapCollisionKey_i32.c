...
struct HashMap_HashMapCollisionKey_i32 HashMap_HashMapCollisionKey_i32__new(struct trait_Allocator allocator) {
    ...
    return HashMap_HashMapCollisionKey_i32__with_capacity(allocator, 16);
}
...
struct HashMap_HashMapCollisionKey_i32 HashMap_HashMapCollisionKey_i32__with_capacity(struct trait_Allocator allocator, uintptr_t capacity) {
    ...
    struct HashMap_HashMapCollisionKey_i32 self = (struct HashMap_HashMapCollisionKey_i32) {
        .allocator = allocator,
        .buckets = 0,
        .data = 0,
        .capacity = 0,
    ...
    HashMap_HashMapCollisionKey_i32__resize(&self, capacity);
...
void HashMap_HashMapCollisionKey_i32__resize(struct HashMap_HashMapCollisionKey_i32* self, uintptr_t new_capacity) {
    ...
    self->buckets = self->allocator.vtable->fn_realloc(self->allocator.instance, self->buckets, new_capacity * sizeof(struct HashMapBucket_HashMapCollisionKey_i32*));
    #line 56 "src/std/HashMap.pv"
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, new_capacity * sizeof(struct HashMapBucket_HashMapCollisionKey_i32));
    #line 57 "src/std/HashMap.pv"
    self->capacity = new_capacity;
    #line 58 "src/std/HashMap.pv"
    HashMap_HashMapCollisionKey_i32__fill_buckets(self);
}
...
int32_t* HashMap_HashMapCollisionKey_i32__find(struct HashMap_HashMapCollisionKey_i32* self, HashMapCollisionKey* key) {
    ...
    Hash hash = HashMapCollisionKey__Hash__hash(&(*key));
    #line 65 "src/std/HashMap.pv"
    uintptr_t bucket_index = hash % self->capacity;
    #line 66 "src/std/HashMap.pv"
    struct HashMapBucket_HashMapCollisionKey_i32* current_bucket_node = self->buckets[bucket_index];

    #line 68 "src/std/HashMap.pv"
    while (current_bucket_node != 0) {
        #line 69 "src/std/HashMap.pv"
        if (u64__Eq_u64__eq(HashMapCollisionKey__Hash__hash(&current_bucket_node->key), hash) && HashMapCollisionKey__Eq_HashMapCollisionKey__eq(current_bucket_node->key, *key)) {
...
int32_t* HashMap_HashMapCollisionKey_i32__insert(struct HashMap_HashMapCollisionKey_i32* self, HashMapCollisionKey key, int32_t value) {
    ...
    int32_t* existing_value = HashMap_HashMapCollisionKey_i32__find(self, &key);
    ...
    if (usize__Eq_usize__eq(self->capacity, 0) || (self->length * 100 / self->capacity) > 75) {
        ...
        HashMap_HashMapCollisionKey_i32__resize(self, self->capacity * 2);
    }
    ...
    struct HashMapBucket_HashMapCollisionKey_i32* bucket_node = *current_bucket_node;
    ...
    self->data[self->length] = (struct HashMapBucket_HashMapCollisionKey_i32) { .key = key, .value = value, .next = 0 };
    #line 100 "src/std/HashMap.pv"
    struct HashMapBucket_HashMapCollisionKey_i32* data = self->data + self->length;
...
bool HashMap_HashMapCollisionKey_i32__remove(struct HashMap_HashMapCollisionKey_i32* self, HashMapCollisionKey* key) {
    ...
    while (current_bucket_node != 0) {
        ...
        if (u64__Eq_u64__eq(HashMapCollisionKey__Hash__hash(&current_bucket_node->key), hash) && HashMapCollisionKey__Eq_HashMapCollisionKey__eq(current_bucket_node->key, *key)) {
            ...
            struct HashMapBucket_HashMapCollisionKey_i32* last = self->data + self->length - 1;
...
void HashMap_HashMapCollisionKey_i32__fill_buckets(struct HashMap_HashMapCollisionKey_i32* self) {
    ...
    for (uintptr_t i = 0; i != self->length; i < self->length ? i++ : i--) {
        ...
        Hash hash = HashMapCollisionKey__Hash__hash(&(*node).key);
...
struct HashMap_HashMapCollisionKey_i32 HashMap_HashMapCollisionKey_i32__clone(struct HashMap_HashMapCollisionKey_i32* self, struct trait_Allocator allocator) {
    ...
    struct HashMap_HashMapCollisionKey_i32 other = (struct HashMap_HashMapCollisionKey_i32) {
        .allocator = allocator,
        .buckets = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(self->data)),
        .data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_HashMapCollisionKey_i32)),
        .length = self->length,
        .capacity = self->capacity,
    };
    #line 170 "src/std/HashMap.pv"
    memcpy(other.data, self->data, self->capacity * sizeof(struct HashMapBucket_HashMapCollisionKey_i32));
    #line 171 "src/std/HashMap.pv"
    HashMap_HashMapCollisionKey_i32__fill_buckets(&other);
...
struct HashMapIter_HashMapCollisionKey_i32 HashMap_HashMapCollisionKey_i32__iter(struct HashMap_HashMapCollisionKey_i32* self) {
    ...
    return (struct HashMapIter_HashMapCollisionKey_i32) {
        .iter = self->data - 1,
...
void HashMap_HashMapCollisionKey_i32__clear(struct HashMap_HashMapCollisionKey_i32* self) {
    ...
    memset(self->data, 0, self->capacity * sizeof(struct HashMapBucket_HashMapCollisionKey_i32));
...
struct HashMapBucket_HashMapCollisionKey_i32* HashMap_HashMapCollisionKey_i32__Index__index(void* __self) {
    struct HashMap_HashMapCollisionKey_i32* self = __self; (void)self;
...
struct trait_Map_HashMapCollisionKey_i32VTable HASH_MAP_HASH_MAP_COLLISION_KEY_I32__VTABLE__MAP = { .fn_find = &HashMap_HashMapCollisionKey_i32__Map_HashMapCollisionKey_i32__find, .fn_insert = &HashMap_HashMapCollisionKey_i32__Map_HashMapCollisionKey_i32__insert, .fn_remove = &HashMap_HashMapCollisionKey_i32__Map_HashMapCollisionKey_i32__remove };
