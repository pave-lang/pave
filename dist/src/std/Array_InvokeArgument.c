...
struct Array_InvokeArgument Array_InvokeArgument__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_InvokeArgument) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_InvokeArgument Array_InvokeArgument__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_InvokeArgument self = (struct Array_InvokeArgument) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_InvokeArgument__reserve(struct Array_InvokeArgument* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct InvokeArgument));
...
struct Array_InvokeArgument Array_InvokeArgument__clone(struct Array_InvokeArgument* self, struct trait_Allocator allocator) {
    ...
    struct InvokeArgument* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct InvokeArgument));
...
struct InvokeArgument* Array_InvokeArgument__Index__index(void* __self) {
    struct Array_InvokeArgument* self = __self; (void)self;
