...
struct HashMap_str_TypedefC HashMap_str_TypedefC__new(struct trait_Allocator allocator) {
    ...
    return HashMap_str_TypedefC__with_capacity(allocator, 16);
}
...
struct HashMap_str_TypedefC HashMap_str_TypedefC__with_capacity(struct trait_Allocator allocator, uintptr_t capacity) {
    ...
    HashMap_str_TypedefC__resize(&self, capacity);
...
void HashMap_str_TypedefC__resize(struct HashMap_str_TypedefC* self, uintptr_t new_capacity) {
    ...
    self->buckets = self->allocator.vtable->fn_realloc(self->allocator.instance, self->buckets, new_capacity * sizeof(struct HashMapBucket_str_TypedefC*));
    #line 56 "src/std/HashMap.pv"
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, new_capacity * sizeof(struct HashMapBucket_str_TypedefC));
...
struct TypedefC* HashMap_str_TypedefC__insert(struct HashMap_str_TypedefC* self, struct str key, struct TypedefC value) {
    ...
    struct HashMapBucket_str_TypedefC* bucket_node = *current_bucket_node;
...
struct HashMap_str_TypedefC HashMap_str_TypedefC__clone(struct HashMap_str_TypedefC* self, struct trait_Allocator allocator) {
    ...
    struct HashMap_str_TypedefC other = (struct HashMap_str_TypedefC) {
        ...
        .data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct HashMapBucket_str_TypedefC)),
        .length = self->length,
...
struct HashMapBucket_str_TypedefC* HashMap_str_TypedefC__Index__index(void* __self) {
    struct HashMap_str_TypedefC* self = __self; (void)self;
...
struct trait_Map_str_TypedefCVTable HASH_MAP_STR_TYPEDEF_C__VTABLE__MAP = { .fn_find = &HashMap_str_TypedefC__Map_str_TypedefC__find, .fn_insert = &HashMap_str_TypedefC__Map_str_TypedefC__insert, .fn_remove = &HashMap_str_TypedefC__Map_str_TypedefC__remove };
