...
struct Array_InlayHint Array_InlayHint__new(struct trait_Allocator allocator) {
    ...
    return (struct Array_InlayHint) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
}
...
struct Array_InlayHint Array_InlayHint__new_with_length(struct trait_Allocator allocator, uintptr_t length) {
    ...
    struct Array_InlayHint self = (struct Array_InlayHint) { .allocator = allocator, .data = 0, .length = 0, .capacity = 0 };
...
void Array_InlayHint__reserve(struct Array_InlayHint* self, uintptr_t capacity) {
    ...
    self->data = self->allocator.vtable->fn_realloc(self->allocator.instance, self->data, capacity * sizeof(struct InlayHint));
...
struct Array_InlayHint Array_InlayHint__clone(struct Array_InlayHint* self, struct trait_Allocator allocator) {
    ...
    struct InlayHint* data = allocator.vtable->fn_alloc(allocator.instance, self->capacity * sizeof(struct InlayHint));
...
struct InlayHint* Array_InlayHint__Index__index(void* __self) {
    struct Array_InlayHint* self = __self; (void)self;
