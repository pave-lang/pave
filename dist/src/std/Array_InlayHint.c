...
struct Array_InlayHint Array_InlayHint__new(struct Allocator allocator) {
    #line 78 "src/std/Array.pv"
    return (struct Array_InlayHint) { .allocator = allocator };
}

#line 81 "src/std/Array.pv"
struct Array_InlayHint Array_InlayHint__new_with_length(struct Allocator allocator, uintptr_t length) {
...
struct Array_InlayHint Array_InlayHint__new_with_capacity(struct Allocator allocator, uintptr_t length) {
...
struct Array_InlayHint Array_InlayHint__clone(struct Array_InlayHint* self, struct Allocator allocator) {
...
struct ArrayIter_ref_InlayHint Array_InlayHint__iter(struct Array_InlayHint* self) {
    #line 186 "src/std/Array.pv"
    return ArrayIter_ref_InlayHint__new((void*)(self->data), (void*)(self->data + self->length));
}
