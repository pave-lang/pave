...
bool test_FunctionCoroutine_fibonacci_1__next(void* _ctx) {
    ...
    ctx->a = 0;
    #line 22 "src/compiler/FunctionCoroutine.pv"
    ctx->b = 1;
...
struct trait_Iter_u64VTable TEST_FUNCTION_COROUTINE_FIBONACCI_1__VTABLE__ITER = { .fn_next = test_FunctionCoroutine_fibonacci_1__next, .fn_value = test_FunctionCoroutine_fibonacci_1__value };
