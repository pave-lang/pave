...
struct trait_Iter_u64VTable test_FunctionCoroutine_fibonacci_1__VTABLE__ITER = { .fn_next = test_FunctionCoroutine_fibonacci_1__next, .fn_value = test_FunctionCoroutine_fibonacci_1__value };
