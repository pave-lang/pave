...
bool Generator__generate_const(struct Generator* self, struct ConstVariable* const_var) {
    ...
    struct str name = const_var->name->value;
    #line 3565 "src/compiler/Generator.pv"
    struct String header = Generator__make_path(self, const_var->module, name, (struct str){ .ptr = ".h", .length = strlen(".h") });
    ...
    Generator__collect_primitive_includes(self, &const_var->type, blank_generics, &primitive_includes);
    ...
    Generator__write_variable_decl(self, header_file, name, &const_var->type, blank_generics);
    #line 3591 "src/compiler/Generator.pv"
    fprintf(header_file, " = ");
    #line 3592 "src/compiler/Generator.pv"
    Generator__write_expression(self, header_file, const_var->value, blank_generics);
...
void Generator__collect_primitive_includes(struct Generator* self, struct Type* type, struct GenericMap* generics, struct HashSet_str* out) {
    ...
    switch (type->type) {
        ...
        case TYPE__CONST: {
            ...
            #line 3612 "src/compiler/Generator.pv"
            Generator__collect_primitive_includes(self, &cv->type, generics, out);
        } break;
...
void Generator__generate_consts_namespace(struct Generator* self, struct HashMap_str_ref_Namespace* children) {
    ...
    while (HashMapIter_str_ref_Namespace__next(&__iter)) {
        ...
        while (HashMapIter_str_ref_Module__next(&__iter)) {
            ...
            { struct HashMapIter_str_ref_ConstVariable __iter = HashMap_str_ref_ConstVariable__iter(&module->const_variables);
            #line 3620 "src/compiler/Generator.pv"
            while (HashMapIter_str_ref_ConstVariable__next(&__iter)) {
                ...
                Generator__generate_const(self, const_var);
            } }
        } }

        #line 3625 "src/compiler/Generator.pv"
        Generator__generate_consts_namespace(self, &namespace->children);
    } }
}
...
bool Generator__generate(struct ArenaAllocator* allocator, char const* path, bool output_line_directives, char const* output_seperator, struct Root* root) {
    ...
    Generator__generate_consts_namespace(&self, &root->children);
