...
struct Include* Include__new(struct Root* root, struct str path, bool mode_cpp) {
    ...
    #line 30 "src/analyzer/Include.pv"
    ...
    #line 50 "src/analyzer/Include.pv"
    ...
    #line 62 "src/analyzer/Include.pv"
    ...
    #line 74 "src/analyzer/Include.pv"
    return self;
}
...
void Include__add_cxtype_primitive(struct Include* self, enum CXTypeKind kind, char const* name) {
    ...
    #line 80 "src/analyzer/Include.pv"
...
bool Include__process(struct Include* self) {
    ...
    #line 109 "src/analyzer/Include.pv"
    ...
    #line 121 "src/analyzer/Include.pv"
    struct CXTranslationUnitImpl* unit = 0;

    #line 123 "src/analyzer/Include.pv"
    ...
    switch (result) {
        ...
        case CXError_Failure: {
            ...
            if (num_errors == 0) {
                ...
                #line 149 "src/analyzer/Include.pv"
            ...
            while (i < num_errors) {
                ...
                #line 157 "src/analyzer/Include.pv"
    ...
    #line 176 "src/analyzer/Include.pv"
    return true;
}
...
struct Type* Include__parse_type(struct Include* self, CXType type) {
    ...
    if (type.kind == CXType_Pointer) {
        ...
        if (is_pointee_const) {
            ...
            #line 196 "src/analyzer/Include.pv"
        ...
        #line 199 "src/analyzer/Include.pv"
    ...
    if (type.kind == CXType_Elaborated) {
        ...
        if (path.length > 0) {
            ...
            while (i > 0) {
                ...
                #line 223 "src/analyzer/Include.pv"
                if (ns_type == 0) {
                    #line 223 "src/analyzer/Include.pv"
    ...
    #line 257 "src/analyzer/Include.pv"
    return &self->root->type_void;
}
...
struct EnumC* Include__find_enum(struct Include* self, char const* name) {
    ...
    #line 268 "src/analyzer/Include.pv"
    return 0;
}
