...
bool Block__parse(struct Block* self, struct Context* context, struct Generics* generics, bool new_scope) {
    ...
    while (!Context__check_value(context, TOKEN_TYPE__SYMBOL, "}")) {
        ...
        if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "defer")) {
            ...
            continue;
        } else if (Token__eq(first_token, TOKEN_TYPE__SYMBOL, "{")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "let")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "return")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "yield")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "if")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "match")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "while")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "for")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "continue")) {
        ...
        } else if (Token__eq(first_token, TOKEN_TYPE__KEYWORD, "break")) {
