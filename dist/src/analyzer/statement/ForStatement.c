...
struct ForStatement* ForStatement__parse(struct Block* parent_block, struct Context* context, struct Generics* generics) {
    ...
    struct Expression* for_expression = for_statement.expression;
    ...
    struct GenericMap* generic_map = Type__get_generic_map(&for_expression->return_type, context);

    #line 63 "src/analyzer/statement/ForStatement.pv"
    bool is_range = false;

    #line 65 "src/analyzer/statement/ForStatement.pv"
    switch (for_expression->data.type) {
        #line 66 "src/analyzer/statement/ForStatement.pv"
        case EXPRESSION_DATA__INVOKE: {
            #line 66 "src/analyzer/statement/ForStatement.pv"
            struct Expression* target = for_expression->data.invoke_value._0;
            #line 66 "src/analyzer/statement/ForStatement.pv"
            struct Array_InvokeArgument args = for_expression->data.invoke_value._1;
            ...
            switch (target->return_type.type) {
                ...
                case TYPE__ENUM: {
                    ...
                    if (enum_name != 0 && str__Eq_str__eq(&enum_name->value, (struct str){ .ptr = "Range", .length = strlen("Range") })) {
                        ...
                        #line 72 "src/analyzer/statement/ForStatement.pv"
                        is_range = true;
                        ...
                        #line 75 "src/analyzer/statement/ForStatement.pv"
                        for_statement.variables.data[0].type = &generic_map->array.data[0];
                    }
                } break;
                #line 78 "src/analyzer/statement/ForStatement.pv"
                default: {
                } break;
            }
        } break;
    ...
    if (is_range) {
        ...
        switch (for_expression->return_type.type) {
            #line 93 "src/analyzer/statement/ForStatement.pv"
            case TYPE__SEQUENCE: {
                #line 93 "src/analyzer/statement/ForStatement.pv"
                struct Sequence* sequence = for_expression->return_type.sequence_value;
                #line 94 "src/analyzer/statement/ForStatement.pv"
                is_sequence = true;
                #line 95 "src/analyzer/statement/ForStatement.pv"
                for_statement.type = (struct ForStatementType) { .type = FOR_STATEMENT_TYPE__SEQUENCE, .sequence_value = for_expression };
                #line 96 "src/analyzer/statement/ForStatement.pv"
                for_statement.iter_type = &for_expression->return_type;
            ...
            case TYPE__INDIRECT: {
                #line 99 "src/analyzer/statement/ForStatement.pv"
                struct Indirect* indirect = for_expression->return_type.indirect_value;
                ...
                switch (indirect->to.type) {
                    ...
                    case TYPE__SEQUENCE: {
                        ...
                        is_sequence = true;
                        #line 103 "src/analyzer/statement/ForStatement.pv"
                        for_statement.type = (struct ForStatementType) { .type = FOR_STATEMENT_TYPE__SEQUENCE, .sequence_value = for_expression };
        ...
        if (!is_sequence) {
            ...
            struct Type* iter_member_type = Expression__get_member_type(context, &for_expression->return_type, iter_member, false);
            #line 119 "src/analyzer/statement/ForStatement.pv"
            ...
            if (!iter_member_is_function) {
                ...
                for_statement.type = (struct ForStatementType) { .type = FOR_STATEMENT_TYPE__ITER, .iter_value = for_expression };
                ...
                Array_InvokeArgument__append(&args, (struct InvokeArgument) { .name = 0, .value = for_expression });
            ...
            #line 139 "src/analyzer/statement/ForStatement.pv"
            ...
            struct Type* value_member_type = Expression__get_member_type(context, iter_type, &value_member, true);
        ...
        while (Iter_ref_ForVariable__next(&__iter)) {
            ...
            if (for_statement.variables.length == 1) {
                ...
                #line 157 "src/analyzer/statement/ForStatement.pv"
                ...
                #line 161 "src/analyzer/statement/ForStatement.pv"
            ...
            #line 169 "src/analyzer/statement/ForStatement.pv"
            if (variable->ref) {
            ...
            String__prepend(&type_name, (struct str){ .ptr = ": ", .length = strlen(": ") });
            #line 175 "src/analyzer/statement/ForStatement.pv"
            Context__inlay_hint(context, variable->name, String__c_str(&type_name), INLAY_HINT_KIND__TYPE, false, false);
