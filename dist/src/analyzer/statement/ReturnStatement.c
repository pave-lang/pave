...
struct ReturnStatement* ReturnStatement__parse(struct Context* context, struct Generics* generics) {
    ...
    #line 21 "src/analyzer/statement/ReturnStatement.pv"
    if (Context__check_next(context, TOKEN_TYPE__SYMBOL, ";")) {
        #line 22 "src/analyzer/statement/ReturnStatement.pv"
        ...
        #line 26 "src/analyzer/statement/ReturnStatement.pv"
        return ArenaAllocator__store_ReturnStatement(context->allocator, (struct ReturnStatement[]){(struct ReturnStatement) {
            .expression = 0,
    ...
    #line 42 "src/analyzer/statement/ReturnStatement.pv"
    return ArenaAllocator__store_ReturnStatement(context->allocator, (struct ReturnStatement[]){(struct ReturnStatement) {
