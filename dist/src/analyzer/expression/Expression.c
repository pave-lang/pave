...
struct Expression* Expression__parse_optional_expression(struct Context* context, struct Expression* inner, struct Generics* generics) {
    ...
    struct Expression* value = Expression__parse_instance_member_expression(context, inner, generics);
...
struct Expression* Expression__parse_instance_member_expression(struct Context* context, struct Expression* inner, struct Generics* generics) {
    ...
    if (member_name == 0) {
        #line 75 "src/analyzer/expression/PostfixExpression.pv"
    ...
    if (is_function && Context__check_value(context, TOKEN_TYPE__SYMBOL, "(")) {
        ...
        #line 120 "src/analyzer/expression/PostfixExpression.pv"
    ...
    if (Token__eq(token, TOKEN_TYPE__SYMBOL, ".")) {
        ...
        switch (Type__resolve_typedef_function(&inner->return_type)->type) {
            ...
            case TYPE__FUNCTION: {
                ...
                #line 310 "src/analyzer/expression/PostfixExpression.pv"
                struct Array_InvokeArgument arguments = Array_InvokeArgument__new((struct trait_Allocator) { .vtable = &ARENA_ALLOCATOR__VTABLE__ALLOCATOR, .instance = context->allocator });

                #line 312 "src/analyzer/expression/PostfixExpression.pv"
                while (!Context__check_value(context, TOKEN_TYPE__SYMBOL, ")")) {
                    #line 313 "src/analyzer/expression/PostfixExpression.pv"
                    struct Expression* argument = Expression__parse(context, generics);
            ...
            default: {
                #line 382 "src/analyzer/expression/PostfixExpression.pv"
    ...
    switch (inner->data.type) {
        ...
        case EXPRESSION_DATA__BINARY_EXPRESSION: {
            ...
            if (str__Eq_str__eq(&op, (struct str){ .ptr = "||", .length = strlen("||") }) && !narrow_on_true) {
                ...
                struct Type* left = Expression__detect_null_narrowing(context, lhs, false);
                ...
                return Expression__detect_null_narrowing(context, rhs, false);
            }
            #line 46 "src/analyzer/expression/BinaryExpression.pv"
            if (str__Eq_str__eq(&op, (struct str){ .ptr = "&&", .length = strlen("&&") }) && narrow_on_true) {
                #line 47 "src/analyzer/expression/BinaryExpression.pv"
                struct Type* left = Expression__detect_null_narrowing(context, lhs, true);
                ...
                return Expression__detect_null_narrowing(context, rhs, true);
            }
            ...
            struct String path_check = String__new((struct trait_Allocator) { .vtable = &ARENA_ALLOCATOR__VTABLE__ALLOCATOR, .instance = context->allocator });
            ...
            if (Expression__build_narrow_path(lhs, &path_check)) {
                #line 59 "src/analyzer/expression/BinaryExpression.pv"
                var_expr = lhs;
                #line 59 "src/analyzer/expression/BinaryExpression.pv"
                other = rhs;
            ...
            if (var_expr == 0) {
                ...
                struct String path_check2 = String__new((struct trait_Allocator) { .vtable = &ARENA_ALLOCATOR__VTABLE__ALLOCATOR, .instance = context->allocator });
                #line 63 "src/analyzer/expression/BinaryExpression.pv"
                if (Expression__build_narrow_path(rhs, &path_check2)) {
                    #line 63 "src/analyzer/expression/BinaryExpression.pv"
                    var_expr = rhs;
                    #line 63 "src/analyzer/expression/BinaryExpression.pv"
                    other = lhs;
    ...
    switch (inner->data.type) {
        ...
        case EXPRESSION_DATA__BINARY_EXPRESSION: {
            ...
            if (str__Eq_str__eq(&op, (struct str){ .ptr = "||", .length = strlen("||") }) && !narrow_on_true) {
                ...
                struct str left = Expression__narrowed_var_name(context, lhs, false);
                ...
                return Expression__narrowed_var_name(context, rhs, false);
            }
            #line 112 "src/analyzer/expression/BinaryExpression.pv"
            if (str__Eq_str__eq(&op, (struct str){ .ptr = "&&", .length = strlen("&&") }) && narrow_on_true) {
                #line 113 "src/analyzer/expression/BinaryExpression.pv"
                struct str left = Expression__narrowed_var_name(context, lhs, true);
                ...
                return Expression__narrowed_var_name(context, rhs, true);
            }
...
struct Expression* Expression__parse_binary(struct Context* context, struct Expression* lhs, uintptr_t min_prec, struct Generics* generics) {
    ...
    while (true) {
        ...
        if (str__Eq_str__eq(&operator->value, (struct str){ .ptr = "||", .length = strlen("||") }) || str__Eq_str__eq(&operator->value, (struct str){ .ptr = "&&", .length = strlen("&&") })) {
            ...
            struct Type* rhs_narrow_type = Expression__detect_null_narrowing(context, result, narrow_on_true_for_rhs);
            #line 173 "src/analyzer/expression/BinaryExpression.pv"
            if (rhs_narrow_type != 0) {
                #line 174 "src/analyzer/expression/BinaryExpression.pv"
                struct str var_name = Expression__narrowed_var_name(context, result, narrow_on_true_for_rhs);
                ...
                if (var_name.length > 0) {
                    ...
                    #line 177 "src/analyzer/expression/BinaryExpression.pv"
                    Context__set_narrowed(context, var_name, rhs_narrow_type);
    ...
    switch (lhs_type->type) {
        ...
        case TYPE__STRUCT: {
            ...
            while (Iter_ref_ref_Impl__next(&__iter)) {
                ...
                #line 274 "src/analyzer/expression/BinaryExpression.pv"
    ...
    switch (Type__deref_reference(&inner->return_type)->type) {
        ...
        case TYPE__STRUCT: {
            ...
            while (Iter_ref_ref_Impl__next(&__iter)) {
                ...
                struct GenericMap* func_map = generic_map;
                #line 408 "src/analyzer/expression/BinaryExpression.pv"
                if (impl_info->typedefs.length > 0) {
                    #line 409 "src/analyzer/expression/BinaryExpression.pv"
                    if (generic_map == 0) {
                        #line 409 "src/analyzer/expression/BinaryExpression.pv"
                        return 0;
                    }
                    #line 410 "src/analyzer/expression/BinaryExpression.pv"
                    struct GenericMap aug_map_val = GenericMap__clone(generic_map, context->allocator);
                    ...
                    while (HashMapIter_str_Type__next(&__iter)) {
                        ...
                        #line 416 "src/analyzer/expression/BinaryExpression.pv"
                        GenericMap__insert(aug_map, name, *resolved);
                    } }
                    #line 418 "src/analyzer/expression/BinaryExpression.pv"
                    func_map = aug_map;
                }

                #line 421 "src/analyzer/expression/BinaryExpression.pv"
                struct Type* func_type = ArenaAllocator__store_Type(context->allocator, (struct Type[]){(struct Type) { .type = TYPE__FUNCTION, .function_value = { ._0 = func, ._1 = func_map} }});
        ...
        #line 432 "src/analyzer/expression/BinaryExpression.pv"
        default: {
        } break;
    }

    #line 435 "src/analyzer/expression/BinaryExpression.pv"
    return 0;
}

#line 438 "src/analyzer/expression/BinaryExpression.pv"
uintptr_t Expression__get_precedence(struct Token* token) {
    #line 439 "src/analyzer/expression/BinaryExpression.pv"
    if (token->type != TOKEN_TYPE__SYMBOL) {
        #line 439 "src/analyzer/expression/BinaryExpression.pv"
        return 0;
    }

    #line 441 "src/analyzer/expression/BinaryExpression.pv"
    if (str__Eq_str__eq(&token->value, (struct str){ .ptr = "||", .length = strlen("||") })) {
        #line 441 "src/analyzer/expression/BinaryExpression.pv"
        return 1;
    }
    #line 442 "src/analyzer/expression/BinaryExpression.pv"
    if (str__Eq_str__eq(&token->value, (struct str){ .ptr = "&&", .length = strlen("&&") })) {
        #line 442 "src/analyzer/expression/BinaryExpression.pv"
        return 2;
    }
    #line 443 "src/analyzer/expression/BinaryExpression.pv"
    if (str__Eq_str__eq(&token->value, (struct str){ .ptr = "|", .length = strlen("|") })) {
        #line 443 "src/analyzer/expression/BinaryExpression.pv"
        return 3;
    }
    #line 444 "src/analyzer/expression/BinaryExpression.pv"
    if (str__Eq_str__eq(&token->value, (struct str){ .ptr = "^", .length = strlen("^") })) {
        #line 444 "src/analyzer/expression/BinaryExpression.pv"
        return 4;
    }
    #line 445 "src/analyzer/expression/BinaryExpression.pv"
    if (str__Eq_str__eq(&token->value, (struct str){ .ptr = "&", .length = strlen("&") })) {
        #line 445 "src/analyzer/expression/BinaryExpression.pv"
        return 5;
    }
    #line 446 "src/analyzer/expression/BinaryExpression.pv"
    if (str__Eq_str__eq(&token->value, (struct str){ .ptr = "==", .length = strlen("==") }) || str__Eq_str__eq(&token->value, (struct str){ .ptr = "!=", .length = strlen("!=") })) {
        #line 446 "src/analyzer/expression/BinaryExpression.pv"
        return 6;
    }
    #line 447 "src/analyzer/expression/BinaryExpression.pv"
    ...
    #line 448 "src/analyzer/expression/BinaryExpression.pv"
    if (str__Eq_str__eq(&token->value, (struct str){ .ptr = "<<", .length = strlen("<<") }) || str__Eq_str__eq(&token->value, (struct str){ .ptr = ">>", .length = strlen(">>") })) {
        #line 448 "src/analyzer/expression/BinaryExpression.pv"
        return 8;
    }
    #line 449 "src/analyzer/expression/BinaryExpression.pv"
    if (str__Eq_str__eq(&token->value, (struct str){ .ptr = "+", .length = strlen("+") }) || str__Eq_str__eq(&token->value, (struct str){ .ptr = "-", .length = strlen("-") })) {
        #line 449 "src/analyzer/expression/BinaryExpression.pv"
        return 9;
    }
    #line 450 "src/analyzer/expression/BinaryExpression.pv"
    ...
    #line 452 "src/analyzer/expression/BinaryExpression.pv"
    return 0;
}
